...
class GmailProvider(EmailProvider):
    ...
    def get_unprocessed_emails(self):
        ...
        try:
            ...
            results = (
                self.service.users()
                .messages()
                .list(userId="me", q="-label:Processed")
                .execute()
            )
    ...
    def apply_labels(self, email_data, labels):
        ...
        try:
            ...
            self.service.users().messages().modify(
                userId="me", id=email_data["id"], body={"addLabelIds": labels}
            ).execute()
            return True
        except Exception as e:
    ...
    def mark_as_processed(self, email_data):
        ...
        try:
            ...
            self.service.users().messages().modify(
                userId="me", id=email_data["id"], body={"addLabelIds": ["Processed"]}
            ).execute()
            return True
        except Exception as e:
    ...
    def move_to_folder(self, email_data, folder):
        ...
        try:
            ...
            self.service.users().messages().modify(
                userId="me",
                id=email_data["id"],
                body={"addLabelIds": [folder], "removeLabelIds": ["INBOX"]},
            ).execute()
            return True
        except Exception as e:
